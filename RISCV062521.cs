...
namespace RISCVE
{
    public class RISCV
    {
        ...
        //    public NStruct(SyntaxNode node, int val)
        //    {
        //        this.node = node;
        //        this.val = val;
        //    }
        //}
        //NStruct xN = new NStruct();
        //public List<NStruct> xNs = new List<NStruct>();
        //public Stack<NStruct> nStack = new Stack<NStruct>();
        ...
        public override void Visit(SyntaxNode node)
        {
            ...
            switch (node.Kind().ToString())
            {
                ...
                case "SimpleAssignmentExpression":
                    ...
                    xNs.Find(vnm => vnm.node == xN.node).val = xN.val;                    
    ...
    public class Parser
    {
        ...
        StringBuilder sBin;
        public ListBox lB1;
        public List<XN> xVals = new List<XN>();
        public class Rop
        {
            ...
            public override void Visit(SyntaxNode node)
            {
                ...
                switch (node.Kind().ToString())
                {
                    ...
                    case "IdentifierName":
                        ...
                        if ((xV = parser.xVals.Find(vnm => vnm.node == node)) == null)
                        {
                            xV = new XN(node, parser.xVals);
                            parser.xVals.Add(xV);
                        }
                        //nodeStk.Pop();
                        break;
        ...
        private void makCond(String cond, List<XN> vbls, List<uint> uCwds)
        {
